...
function openComplaint() {
    ...
    var userID = getCookie("name"); // Get the user ID from the cookie using the getCookie() function
    var url = "createComplaint.html?userID=" + userID; // Include the user ID as a query parameter in the URL
    var popup = window.open(url, "popup", "width=400,height=500"); // Redirect to the createComplaint.html file with the user ID in the URL
}
